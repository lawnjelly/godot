...
/////////////////////////////////////////////////////////////
// Changing this has large implications to accuracy etc.
// It should fit within i32, yet have room to spare for extensions.
// Originally developed at 16 bit using 65535.

// The key factor for the largest resolution is OVERFLOW, particularly
// in the `find_lines_intersect_integer()` functions.

// #define NAVPHYSICS_MESH_FP_RANGE 65535
// I32_MAX is 0x7FFFFFFF (31 bits)
// Half of I32_MAX is 0x3FFFFFFF (30 bits)
// To store differences between 30 bit range in 32 bit we need to drop again to 29 bit.

//#define NAVPHYSICS_MESH_FP_RANGE (0x1FFFFFFF)
//#define NAVPHYSICS_MESH_FP_RANGE (0xFFFFF)
...
static inline int np_get_shift_from_power_of_2(unsigned int p_pixel) {
...
template <class T>
static T np_nearest_power_of_2_templated(T x) {
	--x;

	// The number of operations on x is the base two logarithm
	// of the p_number of bits in the type. Add three to account
	// for sizeof(T) being in bytes.
	u64 num = np_get_shift_from_power_of_2(sizeof(T)) + 3;
