...
#ifdef DEV_ENABLED
#define NP_DEV_ENABLED

// Excessive checks validate everything to check for bugs.
// Expensive, don't use in normal builds.
//#define NP_DEV_EXCESSIVE_CHECKS
#endif
 ...
 * `NP_ERR_FAIL_COND` for bounds checking.
 */
#define NP_ERR_FAIL_INDEX(m_index, m_size)                                                                         \
 ...
 * error message and returns from the function. This macro should be preferred to
 * `NP_ERR_FAIL_COND_MSG` for bounds checking.
 */
#define NP_ERR_FAIL_INDEX_MSG(m_index, m_size, m_msg)                                                                     \
	if (navphysics_unlikely((m_index) < 0 || (m_index) >= (m_size))) {                                                    \
 ...
 * This macro should be preferred to `NP_ERR_FAIL_COND_V` for bounds checking.
 */
#define NP_ERR_FAIL_INDEX_V(m_index, m_size, m_retval)                                                             \
	if (navphysics_unlikely((m_index) < 0 || (m_index) >= (m_size))) {                                             \
		_NP_ERR_print_index_error(FUNCTION_STR, __FILE__, __LINE__, m_index, m_size, _STR(m_index), _STR(m_size)); \
		return m_retval;                                                                                           \
	} else                                                                                                         \
 ...
 * This macro should be preferred to `NP_ERR_FAIL_COND_V_MSG` for bounds checking.
 */
#define NP_ERR_FAIL_INDEX_V_MSG(m_index, m_size, m_retval, m_msg)                                                         \
	if (navphysics_unlikely((m_index) < 0 || (m_index) >= (m_size))) {                                                    \
		_NP_ERR_print_index_error(FUNCTION_STR, __FILE__, __LINE__, m_index, m_size, _STR(m_index), _STR(m_size), m_msg); \
		return m_retval;                                                                                                  \
	} else                                                                                                                \
 ...
 * prints a generic error message and returns the value specified in `m_retval`.
 * This macro should be preferred to `NP_ERR_FAIL_COND_V` for unsigned bounds checking.
 */
#define NP_ERR_FAIL_UNSIGNED_INDEX(m_index, m_size)                                                                \
 ...
 * This macro should be preferred to `NP_ERR_FAIL_COND_V` for unsigned bounds checking.
 */
#define NP_ERR_FAIL_UNSIGNED_INDEX_V(m_index, m_size, m_retval)                                                    \
	if (navphysics_unlikely((m_index) >= (m_size))) {                                                              \
		_NP_ERR_print_index_error(FUNCTION_STR, __FILE__, __LINE__, m_index, m_size, _STR(m_index), _STR(m_size)); \
		return m_retval;                                                                                           \
	} else                                                                                                         \
 ...
 * If `m_index` is greater than or equal to `m_size`,
 * prints a custom error message and returns the value specified in `m_retval`.
 * This macro should be preferred to `NP_ERR_FAIL_COND_V_MSG` for unsigned bounds checking.
 */
#define NP_ERR_FAIL_UNSIGNED_INDEX_V_MSG(m_index, m_size, m_retval, m_msg)                                                \
	if (navphysics_unlikely((m_index) >= (m_size))) {                                                                     \
		_NP_ERR_print_index_error(FUNCTION_STR, __FILE__, __LINE__, m_index, m_size, _STR(m_index), _STR(m_size), m_msg); \
		return m_retval;                                                                                                  \
	} else                                                                                                                \
 ...
 */
#define NP_ERR_FAIL_NULL(m_param)                                                                          \
 ...
 */
#define NP_ERR_FAIL_NULL_MSG(m_param, m_msg)                                                                      \
	if (navphysics_unlikely(!m_param)) {                                                                          \
 ...
 */
#define NP_ERR_FAIL_NULL_V(m_param, m_retval)                                                              \
	if (navphysics_unlikely(!m_param)) {                                                                   \
		_NP_ERR_print_error(FUNCTION_STR, __FILE__, __LINE__, "Parameter \"" _STR(m_param) "\" is null."); \
		return m_retval;                                                                                   \
	} else                                                                                                 \
 ...
 */
#define NP_ERR_FAIL_NULL_V_MSG(m_param, m_retval, m_msg)                                                          \
	if (navphysics_unlikely(!m_param)) {                                                                          \
		_NP_ERR_print_error(FUNCTION_STR, __FILE__, __LINE__, "Parameter \"" _STR(m_param) "\" is null.", m_msg); \
		return m_retval;                                                                                          \
	} else                                                                                                        \
 ...
 */
#define NP_ERR_FAIL_COND(m_cond)                                                                          \
 ...
 */
#define NP_ERR_FAIL_COND_MSG(m_cond, m_msg)                                                                      \
	if (navphysics_unlikely(m_cond)) {                                                                           \
 ...
 */
#define NP_ERR_FAIL_COND_V(m_cond, m_retval)                                                                                        \
	if (navphysics_unlikely(m_cond)) {                                                                                              \
 ...
 */
#define NP_ERR_FAIL_COND_V_MSG(m_cond, m_retval, m_msg)                                                                                    \
	if (navphysics_unlikely(m_cond)) {                                                                                                     \
 ...
 * Prints a custom error message and returns the value specified in `m_retval`.
 */
#define NP_ERR_FAIL_V_MSG(m_retval, m_msg)                                                                          \
	if (true) {                                                                                                     \
...
#define NP_DEV_ASSERT(m_cond)                                                                                                             \
	if (navphysics_unlikely(!(m_cond))) {                                                                                                 \
		NavPhysics::_NP_ERR_print_error(FUNCTION_STR, __FILE__, __LINE__, "FATAL: NP_DEV_ASSERT failed  \"" _STR(m_cond) "\" is false."); \
		NavPhysics::_NP_ERR_flush_stdout();                                                                                               \
		GENERATE_TRAP                                                                                                                     \
	} else                                                                                                                                \
		((void)0)
#else
...
// Check for overflow, where we either need 64 bit math, or decrease the range.
#ifdef NP_DEV_ENABLED
#define NP_OVERFLOW_CHECKS
#endif

#ifdef NP_OVERFLOW_CHECKS

#define NP_CHECK_32(EXPR)                                                                                    \
	{                                                                                                        \
		i64 _check_res = (i64)EXPR;                                                                          \
		if ((_check_res > INT32_MAX) || (_check_res < -INT32_MAX)) {                                         \
			NavPhysics::_NP_ERR_print_error(FUNCTION_STR, __FILE__, __LINE__, "FATAL: NP_CHECK_32 failed."); \
			NavPhysics::_NP_ERR_flush_stdout();                                                              \
			GENERATE_TRAP                                                                                    \
		} else {                                                                                             \
			((void)0);                                                                                       \
...
#define NP_CHECK_64(EXPR)                                                                                    \
	{                                                                                                        \
		i128 _check_res = (i128)EXPR;                                                                        \
		if ((_check_res > INT64_MAX) || (_check_res < -INT64_MAX)) {                                         \
			NavPhysics::_NP_ERR_print_error(FUNCTION_STR, __FILE__, __LINE__, "FATAL: NP_CHECK_64 failed."); \
			NavPhysics::_NP_ERR_flush_stdout();                                                              \
			GENERATE_TRAP                                                                                    \
		} else {                                                                                             \
			((void)0);                                                                                       \
...
#else
#define NP_CHECK_32(exp)
#define NP_CHECK_64(exp)
#endif
