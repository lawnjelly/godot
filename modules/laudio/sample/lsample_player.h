...
public:
	...
	void play(int32_t p_song_sample_from, int32_t p_dest_num_samples, int32_t p_note_start_sample, int32_t p_note_num_samples, uint32_t p_output_bus_handle, float p_volume);
};
