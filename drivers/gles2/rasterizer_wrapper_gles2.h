...
public:
	...
	RasterizerWrapperSceneGLES2() {}
	~RasterizerWrapperSceneGLES2() {}
};

class RasterizerWrapperStorageGLES2 : public RasterizerStorage {
public:
	/* TEXTURE API */
	struct DummyTexture {
		int width;
...
// FIXME: Disabled during Vulkan refactoring, should be ported.
	...
	RasterizerWrapperStorageGLES2() {}
	~RasterizerWrapperStorageGLES2() {}
};

class RasterizerWrapperCanvasGLES2 : public RasterizerCanvas {
public:
...
protected:
	RasterizerWrapperCanvasGLES2 canvas;
	RasterizerWrapperStorageGLES2 storage;
	RasterizerWrapperSceneGLES2 scene;
