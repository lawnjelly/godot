...
//#include "thirdparty/bgfx/bx/include/bx/bx.h"
...
//	}
	...
	bgfx::ProgramHandle BGFXTest::loadProgram(const char * p_vert, const char * p_frag)
	{
		bgfx::ShaderHandle vsh = BGFX::loadShader(p_vert);
		bgfx::ShaderHandle fsh = BGFX::loadShader(p_frag);
		return bgfx::createProgram(vsh, fsh, true);
	}


	void BGFXTest::init(uint32_t _width, uint32_t _height)
	{
...
//	void mtxLookAt(float* _result, const Vector3& _eye, const Vector3& _at)
//	{
...
//	}
	...
	bool BGFXTest::update()
	{
		...
		if (!entry::processEvents(m_width, m_height, m_debug, m_reset, &m_mouseState) )
		{
			...
			const Vector3 eye = { 0.0f, 0.0f, -35.0f };
			...
			// Set view and projection matrix for view 0.
			{
				...
				float proj[16];
				mtxProj(proj, 60.0f, float(m_width)/float(m_height), 0.1f, 100.0f, bgfx::getCaps()->homogeneousDepth);
