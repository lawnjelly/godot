...
private:
	...
	struct Version {
		bgfx::ShaderHandle handle_vert_shader = BGFX_INVALID_HANDLE;
		bgfx::ShaderHandle handle_frag_shader = BGFX_INVALID_HANDLE;
		//		GLuint id;
		//		GLuint vert_id;
		//		GLuint frag_id;
...
public:
	...
	static _FORCE_INLINE_ ShaderBGFX *get_active() { return active; }
	bool bind();
	void unbind();
...
//int ShaderBGFX::_get_uniform(int p_which) const {
//	ERR_FAIL_INDEX_V(p_which, uniform_count, -1);
//	ERR_FAIL_COND_V(!version, -1);
//	return version->uniform_location[p_which];
//}

void ShaderBGFX::_set_conditional(int p_which, bool p_value) {
