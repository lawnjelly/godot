...
ShaderBGFX *ShaderBGFX::active = nullptr;
...
//GLint ShaderBGFX::get_uniform_location(int p_index) const {
//	ERR_FAIL_COND_V(!version, -1);

//	return version->uniform_location[p_index];
//}

bool ShaderBGFX::bind() {
...
String ShaderBGFX::_mkid(const String &p_id) {
	String id = "m_" + p_id;
	return id.replace("__", "_dus_"); //doubleunderscore is reserved in glsl
}

ShaderBGFX::Version *ShaderBGFX::get_current_version() {
...
//GLint ShaderBGFX::get_uniform_location(const String &p_name) const {
//	ERR_FAIL_COND_V(!version, -1);
//	return glGetUniformLocation(version->id, p_name.ascii().get_data());
//}

void ShaderBGFX::setup(
...
uint32_t ShaderBGFX::create_custom_shader() {
	custom_code_map[last_custom_code] = CustomCode();
	custom_code_map[last_custom_code].version = 1;
	return last_custom_code++;
}

void ShaderBGFX::set_custom_shader_code(uint32_t p_code_id,
...
void ShaderBGFX::set_custom_shader(uint32_t p_code_id) {
	new_conditional_version.code_version = p_code_id;
}

void ShaderBGFX::free_custom_shader(uint32_t p_code_id) {
	/*
...
void ShaderBGFX::use_material(void *p_material) {
	/*
